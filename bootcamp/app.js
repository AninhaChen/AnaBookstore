...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('AnaBookstore.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('AnaBookstore.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('AnaBookstore.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.bookstore.section[obj.sec_n].book.push({'title': obj.title, 'author': obj.author, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('AnaBookstore.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('AnaBookstore.xml', function(err, result) {
      ...
      delete result.bookstore.section[obj.section].book[obj.book];
